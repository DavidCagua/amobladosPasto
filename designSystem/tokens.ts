...
export const decisions = {
  ...
  title: {
    ...
    color: {
      default: choices.colors.brand.primary,
      alt: {
        blue: choices.colors.brand.primary,
        red: choices.colors.brand.primary,
        yellow: choices.colors.brand.primary,
        orange: choices.colors.brand.primary,
  ...
  eyebrow: {
    ...
    color: choices.colors.brand.primary,
  },
  paragraph: {
    fontFamily: choices.fontFamily.sans,
    fontWeight: {
